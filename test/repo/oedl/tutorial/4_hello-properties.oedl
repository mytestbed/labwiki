...
defProperty('theSender', 'nodeX-Y.grid.orbit-lab.org', "ID of sender node")
defProperty('theReceiver', 'nodeX-Y.grid.orbit-lab.org', "ID of receiver node")
...
defProperty('channel', channel, "The WIFI channel to use in this experiment")
defProperty('netid', essid, "The ESSID to use in this experiment")
...
onEvent(:ALL_UP_AND_INSTALLED) do |event|
  info "This is my third OMF experiment"
  wait 10
